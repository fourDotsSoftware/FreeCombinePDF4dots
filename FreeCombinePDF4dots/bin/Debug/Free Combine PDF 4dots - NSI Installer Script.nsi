...
;copy translations end
  ...
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free Combine PDF 4dots"
  !define PRODUCT_SHORTCUT "Free Combine PDF 4dots"
  !define PRODUCT_VERSION "2.2"
  
  !define MUI_ICON "free-combine-pdf-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Free Combine PDF 4dots"
  OutFile "FreeCombinePDFSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Free Combine PDF 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free Combine PDF 4dots - User's Manual.url.lnk" "$INSTDIR\Free Combine PDF 4dots - User's Manual.url" "" "$INSTDIR\Free Combine PDF 4dots - User's Manual.url" 0
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Free Combine PDF 4dots - User's Manual.url";
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Free Combine PDF 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Free Combine PDF 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Free Combine PDF 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Free Combine PDF 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/free-combine-pdf/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/free-combine-pdf/how-to-use.php?afterinstall=true"
FunctionEnd
